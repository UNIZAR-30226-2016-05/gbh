 ...
 */
@WebServlet("/DeleteDest")
public class DeleteDest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uno=request.getParameter("destino");
	...
	/**
	 * @throws IOException 
	 * Si el usuario es administrador, elimina un destino y redirige a home
	 */
	private void buscaPrivado(HttpServletRequest request, HttpServletResponse response, String uno) throws IOException{
		...
		response.sendRedirect("/ProyectoSoftware/Erasmus/home.html" + idCarrera);
	}
